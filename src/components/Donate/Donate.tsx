    ...
    <section>
      <Styled.Main>
        <Styled.Col>
          ...
          <p>Сделаете перевод через <strong>яндекс.деньги или через карту</strong> (<em>кропка выбора справа от суммы</em>) и напишите ваши пожелания или комментарии (<em>имя по желанию</em>). Мы обязательно отобразим перевод на этой странице.</p>
