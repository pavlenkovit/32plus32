...
const Donate: FC = () => {
  ...
  return (
    <section>
      ...
      <Styled.Main>
        <Styled.Content>
          <p>Мы любим и развиваем наш проект <strong>32PLUS32</strong>. У нас нет платных материалов, все программы и статьи доступны для всех <strong>абсолютно бесплатно</strong>.</p>
