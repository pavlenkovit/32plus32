...
const Donate: FC = () => {
  ...
  return (
    <section>
      ...
      <Styled.Main>
        <Styled.Content>
          <p>Мы любим и развиваем проект <strong>32PLUS32</strong>.</p>
          <p>Основные расходы для нас – это хостинг и сервер, технические специалисты и самое главное профессиональные гиревики и тренеры, которые обязательно должны получать оплату за свой труд и опыт.</p>
          <p>Вы можете помочь нам расти дальше и привлекать новых интересных людей, а также внести свой <strong>вклад в развитие гиревого спорта</strong>.</p>
          ...
          <p>В конце каждого месяца мы делаем отчет о собранных средствах в наших соцсетях.</p>
