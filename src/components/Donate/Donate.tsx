    ...
    <section>
      <Styled.Main>
        <Styled.Col>
          ...
          <p>Мы любим и развиваем наш проект <strong>32PLUS32</strong>. У нас нет платных материалов или рекламы, все программы и статьи доступны для всех абсолютно <strong>бесплатно</strong>.</p>
          ...
          <p>Сделаете перевод через <strong>яндекс.деньги или чеерез карту</strong> (<em>кропка выбора справа от суммы</em>) и напишите ваши пожелания или комментарии (<em>имя по желанию</em>). Мы обязательно отобразим перевод на этой странице.</p>
