    ...
    <section>
      ...
      <Styled.Main>
        <Styled.Content>
          ...
          <p>Сделаете перевод через <strong>яндекс.деньги или через карту</strong> (<em>кропка выбора справа от суммы</em>) и напишите ваши пожелания или комментарии (<em>свое имя по желанию</em>). Мы обязательно отобразим перевод на этой странице.</p>
