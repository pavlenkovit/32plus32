...
const ArrowPrevIcon: FC<IProps> = ({ color = '#333', size = 14, className }) => {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 492 492">
